use crate::backend::token::{self, Token};

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(super) struct Udata(u64);
...
impl Udata {
    ...
    pub(super) fn pack(tag: u8, slot: u32, epoch: u32) -> Self {
    ...
    pub(super) fn into_kevent(self) -> *mut libc::c_void {
